...
Diferente de sistemas puramente _stateless_, este projeto implementa persistência total:
...
CHART_DATA_JSON_FUNCTION=sua_funcao_que_converte_os_dados_em_json_no_databricks
